...
// 발급받으신 URL (그대로 유지)
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw_EDmaxOwxVvVWun4MQLB8lETrUPrt8lTTYPTTR_hQhUPpb0PQYNKTP_XU2UT9xbHgNQ/exec";
          ...
          <div className="lg:w-2/5 p-10 lg:p-14 bg-[#F5F2EB] flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-[#EAE8E4]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-pretendard font-bold text-[#2E3A30] text-sm">내 증상에 딱 맞는 수술/비수술 치료 설계</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white p-1 rounded-full shadow-sm">
                    <CheckCircle2 className="w-4 h-4 text-[#2E3A30]" />
                </div>
                <span className="font-pretendard font-bold text-[#2E3A30] text-sm">사후관리까지 철저하게</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-3/5 p-8 lg:p-14 bg-white">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start gap-2 pt-2">
                ...
                />
                <label htmlFor="privacy" className="text-xs text-[#888] cursor-pointer leading-tight">
                    [필수] 상담을 위해 개인정보를 수집 및 이용하는 것에 동의합니다.
                </label>
              </div>
