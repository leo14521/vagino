          ...
          <div className="grid gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm flex items-start gap-4 border border-[#E5E0D8] hover:-translate-y-1 transition-transform duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-[#666]">마취통증의학과 전문의가 상주하여 안전하게 모니터링합니다.</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm flex items-start gap-4 border border-[#E5E0D8] hover:-translate-y-1 transition-transform duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-[#666]">최소 침습 수술법으로 출혈과 붓기를 줄여 당일 퇴원이 가능합니다.</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm flex items-start gap-4 border border-[#E5E0D8] hover:-translate-y-1 transition-transform duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-[#666]">다른 사람과 마주치지 않는 1인실에서 충분히 안정을 취하세요.</p>
              </div>
            </div>
          </div>
        </div>
